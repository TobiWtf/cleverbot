module.exports = function(d) {
    ...
    return u(encodeURIComponent(r.toLowerCase()));
};
...
/**
 * https://stackoverflow.com/questions/38167154/javascript-unescape-function-definition *
 * `unescape` function is deprecated, so this function from Stack Overflow was used.
 */
function u(s) {
    s = s.toString(s);
    var n = s.length;
